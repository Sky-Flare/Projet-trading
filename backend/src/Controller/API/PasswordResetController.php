...
class PasswordResetController extends AbstractController
{
    ...
    public function SendResetPasswordToken($username, MailerInterface $Mailer): Response //Est appelé quand l'user met son username pour changer de mot de passe..
    {
        ...
        if ($User && !empty($username)) {
            $RouteUpdatePassword = "http://localhost:8080/nouveau-mot-de-passe/"; //Par exemple.. le front devra la créer..
            ...
            $Content = "Bonjour $username Pour réinitialiser votre mot de passe, veuillez cliquer sur le lien ci-dessous :<br/><br/>";
